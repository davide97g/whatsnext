  ...
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-[var(--radius)] border border-line-strong bg-surface p-6 shadow-2xl",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 text-muted transition-colors hover:text-ink focus-visible:outline-none">
        <X className="size-4" />
